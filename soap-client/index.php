...
<legend>Tambah Data</legend>	
	...
	<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
		...
		<!----
		<div class="control-group">
			<label class="control-label" for="nama_almt">Alamat</label>
			<div class="controls">
				<input type="text" name="nama_almt" class="input-medium" placeholder="Alamat"
					rel="tooltip" data-placement="right" title="Masukkan Alamat Mahasiswa"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="no_hp">Nomor HP</label>
			<div class="controls">
